...
The internal React-shell selector uses the same assembly path but includes the
standalone hydration bundle and matching document entry; ordinary CLI exports
remain on the default inventory until the planned atomic flip.
