...
const reactHeaders = { "x-mokly-shell": "react" };
...
test("switched Serve and export render a removed route", async (context) => {
...
test("switched Serve and export distinguish renamed routes", async (context) => {
  const fixture = await createExportFixture(pageSource());
  context.after(() => fixture.close());
