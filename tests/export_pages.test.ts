...
mockups.push(definePage({ id: "handbook", title: "Handbook", description: "Catalogue guidance", dependencies: [], navPath: ["Library"], relatedDocs: [], route: ${JSON.stringify(route)}, render: () => '<!doctype html><html><body><h1 id="start">Handbook</h1><a href="mock:home">Home</a></body></html>' }));`;
}
