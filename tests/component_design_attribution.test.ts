...
test("mixed component design styles retain their actual rendered resource scope", async (t) => {
  ...
  for (const [stylesheet, screens, components] of [
    ["design-components.css", 36, 15],
    ["design-component-inspection.css", 36, 15],
    ["design-component-details.css", 36, 15],
    ["design-component-inspector.css", 72, 15],
    ["design-component-panel-index.css", 4, 0],
    ["design-component-panel-tree.css", 4, 0],
    ["design-component-panel-variants.css", 4, 0],
    ["design-component-workspace.css", 72, 15],
    ["design-component-view.css", 36, 15],
