...
const action = defineComponent({ ...metadata,
  id: "action", title: "Action", description: "A shared action", route: "components/action.html", navPath: ["Components"],
...
const pane = defineComponent({ ...metadata,
  id: "pane", title: "Pane", description: "A caller-owned content slot", route: "components/pane.html", navPath: ["Components"],
