...
routes, and regenerate the then-current manifest v5 with `sourceFiles`. Earlier
v2/v3 output was rejected; historical readers remain available only for Git
comparisons. Current builds emit manifest v6. Follow
