...
| `design-browse-dark-scheme`           | `design/browse/views/screen.variants/dark-scheme.html`          | Dark selected, dark device screens                         |
| `design-browse-light-only`            | `design/browse/views/screen.variants/light-only.html`           | Light-only screen under dark                               |
