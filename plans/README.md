...
- [Path-Based Navigation Hierarchy](./nav-path-hierarchy.md) — replace
  ...
  model v2. Milestones 1–5 are implemented, verified, and pushed (Milestone 5
  fixed review findings 3 and 4); findings 1 and 2 await the user's decision,
  and the plan stays Active until its PR merges.
