...
- [Screen Variants Follow-up](./screen-variants-follow-up.md) — implementation
  ...
  [PR #115](https://github.com/mokly-ai/mokly/pull/115). The approved historical
  snapshot-selection review fix is in progress; the plan remains Active until
  merge. Later navigation ideas remain non-blocking follow-ups.
