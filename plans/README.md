...
- [Screen Variants Follow-up](./screen-variants-follow-up.md) — implementation
  ...
  snapshot-selection and mockup parity fixes are verified; the final parity
  push and review remain. The plan stays Active until merge. Later navigation ideas
