...
- [x] Merge `origin/main` and preserve both branches' protocol and plan index
      entries while resolving conflicts.
- [x] Document `--open` in the packaged Serve CLI and getting-started guides so
      their public option inventory matches the parser and help output.
